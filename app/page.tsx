    ...
    <main id="top">
      <header className="site-header">
        ...
        <nav aria-label="Report sections">
          <a href="#live-quarters">Quarterly data</a>
          <a href="#live-markets">Current rates</a>
          <a href="#audit">Research audit</a>
          <a
      ...
      <div className="report-shell">
        <LiveDashboard />
        <details id="audit" className="audit-archive">
          <summary>
            <span>RESEARCH AUDIT · 05 SEP 2026</span>
            <strong>
              Read the full methodology, governance evidence and source register
            </strong>
            <small>
              Dated observations · live financial data appears above
            </small>
          </summary>
          ...
          <p className="audit-correction">
            Correction made during live integration on 5 September 2026: the
            savings target is APR, not APY. The rate comparison below has been
            corrected. Removing only GSM revenue also retains facilitator
            deposit yield; it does not isolate borrow-only net income.{' '}
            <Cite id="savingsConvention" />
          </p>
          <section id="verdict" className="intro">
            ...
            <div className="finding">
              ...
              <p>
                ...
                includes GSM income. A reconstruction excluding GSM income turns
                negative for that reported scope. Missing cost reconciliation
                and coverage differences prevent a definitive DAO-wide net
                figure or a verified first profitable quarter.{' '}
                <Cite id="financials" />
                <Cite id="statements" />
              </p>
            </div>
          ...
          <div className="metrics">
            ...
            <div className="metric">
              ...
              <p>
                Approximate, same reported scope, GSM income removed.
                Facilitator deposit yield remains included; this is not
                borrow-only net income. <Cite id="financials" />
              </p>
            </div>
            <div className="metric">
          ...
          <section id="definition" className="section">
            ...
            <div className="two-col prose-grid">
              <div>
                ...
                <p>
                  The supplied DefiLlama methodology anchor treats all native
                  GHO borrower interest as DAO revenue; that says nothing about
                  incentive deductions. TokenLogic separates “Borrow Fees (GHO)”
                  from interest on facilitator-minted GHO deposited in lending
                  markets. Both are shown here so the DAO’s supply-side capture
                  is not lost. <Cite id="statements" />
                </p>
                <p>
              ...
              <div>
                ...
                <p>
                  ...
                  costs, not borrower discounts. Protocol-wide insurance costs
                  are not all attributable to GHO.
                </p>
              </div>
            </div>
          </section>
          ...
          <section id="reconstruction" className="section">
              ...
              <TabsContent value="strict">
                <div className="reconstruction">
                  ...
                  <div className="ledger-explanation">
                    ...
                    <p>
                      This is a diagnostic of the provider’s reported scope. It
                      is not a verified global loss: cost recognition, coverage
                      and additional adjustments remain unresolved.{' '}
                      <Cite id="financials" />
                    </p>
                  </div>
                </div>
              ...
              <TabsContent value="broad">
                <div className="reconstruction">
                  ...
                  <div className="ledger-explanation">
                    ...
                    <p>
                      Component values and the net card are independently
                      rounded. Their arithmetic need not sum exactly. The
                      dashboard also shows cumulative revenue of $24.92M and
                      expenses of $25.16M, a derived cumulative balance of
                      approximately −$0.24M. <Cite id="financials" />
                    </p>
                    <p>
            ...
            <div className="caution">
              ...
              <p>
                ...
                scopes are not reconciled. Its annualization text refers to both
                a trailing 90-day window and the most recent month. Its GHO
                chart and general financial statements are also not fully
                reconciled. We therefore do not scale these margins to total
                circulating supply or read a break-even date from chart pixels.{' '}
                <Cite id="financials" />
                <Cite id="statements" />
              </p>
            </div>
          ...
          <section id="quarters" className="section">
            ...
            <div className="quarter-takeaway">
              ...
              <p>
                Reported borrow fees of <strong>$997.60K</strong> plus
                facilitator yield of <strong>$402.10K</strong> give a derived
                DAO-interest proxy of <strong>$1.39970M</strong>. The
                statements’ broader GHO Earnings total is{' '}
                <strong>$2.86M</strong>, including GSM income and a
                treasury-interest adjustment. The sum follows the provider’s
            ...
            <p className="table-note">
              Every row: <SourceLink id="statements" />; USD, observed 5
              September 2026. A dash preserves an unreported source cell; it is
              not an assumed zero. sGHO/Merit is a funding-transfer line, not
              total actual GHO Merit payouts. Liquidity and CEX transfers may
              include recoverable inventory. stkGHO rewards are denominated in
              AAVE and valued in USD by the provider.
            </p>
            <details className="history">
              <summary>
            ...
            <p className="table-note">
              * Native discount only: the v3.4 upgrade removed it around July
              ...
              subsequent quarters is limited to that removed native mechanism;
              it does not assert that all potential reward programs cost zero.{' '}
              <Cite id="discount" />
            ...
            <div className="two-col prose-grid">
              <div>
                ...
                <p>
                  The statements define sGHO/Merit recognition at transfer to
                  the incentive manager. Other ACI and Merkl lines span multiple
                ...
                <p>
                  ...
                  program. The annual GHO-attributed protocol-revenue headline
                  of $12.7M for 2025 is also not explicitly a
                  pure-borrow-interest figure. <Cite id="transparency" />
                </p>
              </div>
              <div>
                ...
                <p>
                  ...
                  allocation and overlap are unresolved. Their source
                  observations are preserved in the repository dataset.{' '}
                  <Cite id="statements" />
                </p>
                <p>
            ...
            <details className="history">
              ...
              <p className="detail-copy">
                ...
                reimbursements of 21,322.38 GHO and 11,655 GHO: a derived total
                of 32,977.38 GHO. These are token amounts, not independently
                valued historical USD expenses. The router serves both GSM swaps
                and savings flows; the GSM-only allocation, expense-incurrence
                dates and inclusion in other cost lines remain unverified. Do
                not add the amount again without reconciliation.{' '}
                <Cite id="auditApril" />
                <Cite id="auditJune" />
              </p>
            </details>
          ...
          <section id="spread" className="section">
            ...
            <div className="spread-layout">
              <figure
                ...
                aria-label="Reported GHO borrow and savings APYs on September 5, 2026. Core 4.08 percent; Prime 3.74; Horizon 3.05; Monad 3.88; savings 4.59."
              >
                {[
                  { name: 'Ethereum Core · borrow', rate: 4.08, id: 'aave' },
                  {
                    name: 'Ethereum Prime · borrow',
                    rate: 3.74,
                    id: 'markets',
                  },
                  { name: 'Horizon · borrow', rate: 3.05, id: 'markets' },
                  { name: 'Monad · borrow', rate: 3.88, id: 'markets' },
                  { name: 'GHO Savings · payout', rate: 4.59, id: 'savings' },
                ].map((r, i) => (
                  <div
                ...
                <p className="micro-note">
                  Borrow rates are APY. Savings display APY is derived from
                  4.50% APR using Aave’s monthly-compounding convention.
                  Observed 5 September 2026; rates can change.
                </p>
              </figure>
              <div className="spread-reading">
                ...
                <p>
                  Core borrow APY less the displayed Savings APY: 4.08% − 4.59%.
                ...
                <p>
                  ...
                  loss. Borrow balances, savings balances, facilitator
                  ownership, other incentives and GSM backing all differ.
                </p>
              </div>
            </div>
            <div className="two-col prose-grid">
              <div>
                ...
                <p>
                  The official Core page shows 111.56M GHO debt against a
                  150.00M borrow cap: 74.37% cap usage. This is minting
                  headroom, not conventional supplier utilization. TokenLogic
                  shows Prime at 86%, Horizon at 54% and Monad at 88%
                  utilization, each with its own market denominator.{' '}
                  <Cite id="aave" />
                  <Cite id="markets" />
                </p>
              </div>
              <div>
                ...
                <p>
                  Aave’s Savings banner shows $161.64M of deposits. The
                  configured savings rate is 4.50% APR (approximately 4.59%
                  display APY). Holding the displayed balance and APR constant
                  for a year implies approximately $7.27M of savings returns,
                  before other incentives or costs. This is a scenario, not a
                  forecast. This uses the banner’s USD valuation and does not
                  reconstruct historical payment-date costs.{' '}
                  <Cite id="savings" />
                </p>
                <p>
                  A complete forward net needs simultaneous DAO-captured borrow
                  balances and rates across all facilitators, and current costs
                  on a consistent scope. The evidence does not establish a
          ...
          <section id="claims" className="section">
            ...
            <div className="timeline">
              <article>
                ...
                <div>
                  ...
                  <p>
                    ACI anticipated break-even around 150–175M GHO supply. It
                    was a forward estimate, not proof of a quarter’s realized
                    net income. <Cite id="forecast" />
                  </p>
                  <SourceLink
                    id="aavenomicsVote"
              ...
              <article>
                ...
                <div>
                  ...
                  <p>
                    ...
                    rate. Carrying the old 275,000 GHO weekly funding rate
                    forward and adding all native savings costs would
                    double-count the replaced program. <Cite id="launch" />
                    <Cite id="may" />
                  </p>
                </div>
              </article>
              <article>
                ...
                <div>
                  ...
                  <p>
                    ...
                    It neither supplies all requested adjustments nor verifies
                    the first profitable quarter under this question’s
                    definition. <Cite id="financials" />
                  </p>
                </div>
              </article>
            </div>
            <p className="table-note">
              ...
              speculative potential profit, not an official DAO financial
              report. <Cite id="community" /> Initial Merit funding was also put
              to Snapshot; proposal approval is spending authorization, not
              expense evidence. <Cite id="meritVote" />
            </p>
          </section>
          ...
          <section id="dashboards" className="section">
            ...
            <div className="dashboard-grid">
              <article>
                ...
                <p>
                  GHO Financials publishes a broader P&amp;L. Financial
                  Statements supplies numerical quarterly rows and accounting
                  notes. Market views supply current rates. Refreshed-through
                  timestamps were not consistently exposed; public records
                  extended to the observation date.
                </p>
            ...
            <div id="dune-coverage" className="coverage-extra">
              ...
              <Table className="research-table coverage-table">
                ...
                <TableBody>
                  ...
                  <TableRow>
                    ...
                    <TableCell>
                      Avalanche GHO supply, debt, mint/burn. Query cards
                      required a run; results unavailable anonymously.
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>
                  ...
                  <TableRow>
                    ...
                    <TableCell className="date-cell">Unverified</TableCell>
                    <TableCell>
                      The separate risk dashboard did not resolve in the
                      browser. Its historical launch article describes risk
                      monitoring, not a P&amp;L. <Cite id="chaosLaunch" />
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
              <p className="table-note">
                ...
                current financial figures were inferred from stale or
                unavailable query cards.
              </p>
            </div>
          </section>
          ...
          <section id="confidence" className="section">
            ...
            <div className="confidence-grid">
              <div>
                <span className="badge reported">
                  HIGH · SOURCE OBSERVATIONS
                </span>
                <h3>What the sources display</h3>
                <p>
                  Quarterly revenue rows, named transfer categories, live APYs
                  and governance statements. Values are preserved at their
                  displayed precision and linked to the source.
                </p>
              </div>
              <div>
            ...
            <div className="conclusion">
              ...
              <p>
                ...
                definition. The diagnostic excluding GSM income is negative
                within that dashboard’s scope. The complete DAO-wide net and its
                first profitable quarter remain unverified.
              </p>
            </div>
          </section>
          ...
          <section id="sources" className="section">
            ...
            <div id="scope" className="scope-note">
              ...
              <p>
                This audit is a dated research snapshot. The live dashboard
                above refreshes financial statements and market data separately.
                The requester supplied the circulating-supply and fee-adapter
                anchors; those were accepted, not re-derived. Protocol-wide fee
                and revenue totals are not used as GHO-specific revenue. Every
                quoted or derived monetary amount elsewhere has a source
                reference, reporting context and the common observation date
                above.
              </p>
              <p>
                The source repository preserves the transcribed data,
                distinctions between token units and USD, and methodology notes.
                A future update should reconcile facilitator coverage, obtain
                exact exports, match reward distributions to budgets, remove
                recoverable principal and reconcile bad debt and operating costs
                before assigning a first profitable quarter.
              </p>
            </div>
          </section>
        </details>
